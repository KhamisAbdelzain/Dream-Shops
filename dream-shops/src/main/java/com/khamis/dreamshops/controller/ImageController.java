...
import com.khamis.dreamshops.service.imageService.IImageService;
...
public class ImageController {
    ...
    try {
        ...
        return ResponseEntity.ok(new ApiResponse("Update Seccess",null));
    ...
    return ResponseEntity.status(INTERNAL_SERVER_ERROR).body(new ApiResponse("updateFaild",INTERNAL_SERVER_ERROR));
    }
    ...
    public ResponseEntity<ApiResponse>deleteImage(@PathVariable Long imageId){
        try {
            ...
            if (image !=null){
                ...
                return ResponseEntity.ok(new ApiResponse("Delete Seccess",null));
